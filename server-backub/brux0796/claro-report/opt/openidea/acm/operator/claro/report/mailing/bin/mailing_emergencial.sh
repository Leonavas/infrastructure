...
split_mailing ${DIR_MAILING_OUT}"/clarosupergiga_optout_"${current_day}".txt"  ${DIR_MAILING_FINAL}"/clarosupergiga_optout_"${current_day} ${NR_FILES} 400000

##########################################
####### Definicao de prioridade ZB #######
##########################################
head -99993 ${DIR_MAILING_OUT}/zb_saldo_acima_8_giga_${current_day}.txt >> ${DIR_MAILING_FINAL}/zb_saldo_acima_8_giga_${current_day}.txt
head -99993 ${DIR_MAILING_OUT}/zb_saldo_acima_8_super_giga_${current_day}.txt  >> ${DIR_MAILING_FINAL}/zb_saldo_acima_8_super_giga_${current_day}.txt
head -2099993 ${DIR_MAILING_OUT}/zb_saldo_ate_8_${current_day}.txt >> ${DIR_MAILING_FINAL}/zb_saldo_ate_8_${current_day}.txt

cat ${DIR_MAILING_OUT}/mailing_adicional.txt >> ${DIR_MAILING_FINAL}/zb_saldo_acima_8_giga_${current_day}.txt
cat ${DIR_MAILING_OUT}/mailing_adicional.txt >> ${DIR_MAILING_FINAL}/zb_saldo_acima_8_super_giga_${current_day}.txt
cat ${DIR_MAILING_OUT}/mailing_adicional.txt >> ${DIR_MAILING_FINAL}/zb_saldo_ate_8_${current_day}.txt
...
#scp ${DIR_MAILING_FINAL}zb_saldo*  acm@jundiai:/home/nuance_uplift/
#scp ${DIR_MAILING_FINAL}*torpedo*  acm@jundiai:/home/nuance_uplift/
