#!/bin/bash
#
# Copia arquivo de de score  do servidor Santo Anastacio e move para os locais de processamento
#
#
...
IN=$DIR/in/$SCRIPT
DEST=$DIR/customer_update/balance-pdi/ext/unp/score_zb
SOURCE_PATTERN="acm@10.18.50.175:/D/interface/UPLIFT/FX_SCORE_ZB*"
