...
TMP_DIR=${HOME_DIR}"/tmp_1dia/"${P_PID}
SRC_DIR=${HOME_DIR}"/split_1dia"
OUT_DIR=${HOME_DIR}"/trunc_1dia"
...
IN_PARAMS="${IN_PARAMS} -param:acm.job.file.out.volume="${HOME_DIR}"/trunc_1dia/Volumetria_"${MAILING_DATE}".txt"
