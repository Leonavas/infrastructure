#!/bin/bash
#
# Copia arquivo de UPLIFT_CANCELADOS  do servidor Santo Anastacio e move para os locais de processamento
#
#
...
SOURCE_PATTERN="acm@10.18.50.175:/D/interface/UPLIFT/UPLIFT_CANCELADOS*"
SOURCE_FOLDER="D:\interface\UPLIFT"
SOURCE_IP="10.18.50.175"
SOURCE_USER="acm"

rm $DEST/UPLIFT_CANCELADOS*
