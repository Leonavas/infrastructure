#!/bin/bash
#
# Copia arquivo de APAREL_VERSUS_TECNOL_UPLIFT  do servidor Santo Anastacio e move para os locais de processamento
#
#
...
IN=$DIR/in/$SCRIPT
DEST=/opt/openidea/acm/bkp
SOURCE_PATTERN="acm@10.18.50.175:/D/interface/UPLIFT/*APAREL_VERSUS_TECNOL_UPLIFT*"
SOURCE_FOLDER="D:\interface\UPLIFT"
SOURCE_IP="10.18.50.175"
SOURCE_USER="acm"

rm $DEST/*APAREL_VERSUS_TECNOL_UPLIFT*
