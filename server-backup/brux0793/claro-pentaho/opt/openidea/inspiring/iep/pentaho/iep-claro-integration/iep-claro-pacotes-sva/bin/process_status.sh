...
input_file_pattern="UPLIFT_SRVS_CONTRATADOS__*\.txt\.gz"
log_file_pattern="iep-claro-pacotes-sva_*"
process_bin="iep-claro-integration/iep-claro-pacotes-sva/bin/start_process.sh"
