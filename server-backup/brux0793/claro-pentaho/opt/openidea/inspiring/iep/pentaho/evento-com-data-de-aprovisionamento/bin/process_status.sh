...
input_file_pattern="UPLIFT_SALDOS_*\.txt\.gz"
log_file_pattern="evento-com-data-de-aprovisionamento_*"
process_bin=" evento-com-data-de-aprovisionamento/bin/start_process.sh"
...
{
    p_logfile=$1
    total_lines=$(grep "Verifica resposta 2.0 - Finished processing" ${p_logfile} | grep -Eo "W\=[0-9]+\," | tr -d "W\=\,")
