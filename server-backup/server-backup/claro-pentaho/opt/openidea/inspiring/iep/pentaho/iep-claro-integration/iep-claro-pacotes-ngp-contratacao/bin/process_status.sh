...
input_file_pattern="UPLIFT_NGP_CONTRATADOS_*\.txt\.gz"
log_file_pattern="iep-claro-pacotes-ngp-contratacao_*"
process_bin="iep-claro-pacotes-ngp-contracacao/bin/start_process.sh"
